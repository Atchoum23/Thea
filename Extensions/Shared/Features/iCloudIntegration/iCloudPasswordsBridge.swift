...
public final class iCloudPasswordsBridge: ObservableObject {
    ...
    public func generateStrongPassword(passwordRules _: String? = nil) -> String {
...
public enum iCloudError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .notConnected:
            "Not connected to iCloud Passwords"
        case .authenticationFailed:
...
public extension Notification.Name {
    static let iCloudCredentialUpdated = Notification.Name("com.thea.iCloudCredentialUpdated")
    static let iCloudPasswordsConnected = Notification.Name("com.thea.iCloudPasswordsConnected")
    static let iCloudPasswordsDisconnected = Notification.Name("com.thea.iCloudPasswordsDisconnected")
}
