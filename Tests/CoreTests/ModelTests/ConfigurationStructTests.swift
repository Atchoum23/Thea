...
/// Standalone tests for configuration struct types (Part 2a of 3).
/// Covers: PerformanceMetrics, QAToolResult, QAIssue, ConversationConfiguration,
/// OrchestratorConfiguration. See also ConfigurationTypesTests.swift (enums)
/// and ConfigurationAdvancedTests.swift (SystemPrompt, Verification, Security).
final class ConfigurationStructTests: XCTestCase {

    // MARK: - Shared Enum Doubles
    ...
    // =========================================================================
    // MARK: - 14. ConversationConfiguration
    // =========================================================================
    ...
    func testConversationConfigAvailableContextForChat() {
        ...
        let full = config.getAvailableContextForChat(provider: "anthropic/claude-sonnet-4")
        XCTAssertEqual(full, 200_000)
    }
    ...
    // =========================================================================
    // MARK: - 15. OrchestratorConfiguration
    // =========================================================================
