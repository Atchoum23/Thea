...
//
// NOTE: This file contains only the class definition, stored properties, and init.
// All method implementations are in extension files:
//   +Hardware.swift   — System hardware detection
//   +Helpers.swift    — Monitoring, user profile, configuration persistence, utility methods
//   +Recommendations.swift — Recommendation generation and scoring
//   +Scanning.swift   — Model scanning and discovery
...
final class LocalModelRecommendationEngine {
    ...
    // MARK: - State
    // Note: These are `var` (not `private(set)`) because extension files in
    // +Hardware, +Helpers, +Recommendations, +Scanning need setter access.
