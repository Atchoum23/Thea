...
private struct SmitheryServerListResponse: Codable {
...
private struct SmitheryServer: Codable {
...
private struct SmitheryTool: Codable {
    let name: String
    let description: String
}
...
private struct LocalMCPConfig: Codable {
