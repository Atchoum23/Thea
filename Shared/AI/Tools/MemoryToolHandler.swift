...
enum MemoryToolHandler {
    ...
    static func search(_ input: [String: Any]) async -> AnthropicToolResult {
        ...
        let results = await PersonalKnowledgeGraph.shared.searchEntities(query: query)
        if results.isEmpty {
    ...
    static func add(_ input: [String: Any]) async -> AnthropicToolResult {
        ...
        await PersonalKnowledgeGraph.shared.addOrMergeEntity(entity)
    ...
    static func list(_ input: [String: Any]) async -> AnthropicToolResult {
        ...
        let entities = await PersonalKnowledgeGraph.shared.searchEntities(
    ...
    static func update(_ input: [String: Any]) async -> AnthropicToolResult {
        ...
        _ = updated  // suppress unused-var warning
        await PersonalKnowledgeGraph.shared.addOrMergeEntity(updated)
