...
class TrainingJob: Identifiable, @unchecked Sendable {
  ...
  init(
    id: UUID, provider: String, baseModel: String, status: JobStatus, trainingFile: String,
    config: FineTuningConfig, createdAt: Date, startedAt: Date?, completedAt: Date?,
    fineTunedModel: String?, metrics: TrainingMetrics
  ) {
    self.id = id
...
class TrainingFewShotExample: Identifiable {
  ...
  init(
    id: UUID, category: String, input: String, output: String, explanation: String, createdAt: Date,
    useCount: Int
  ) {
    self.id = id
...
class TrainingPromptTemplate: Identifiable {
  ...
  init(
    id: UUID, name: String, category: String, template: String, variables: [String],
    createdAt: Date, useCount: Int
  ) {
    self.id = id
    self.name = name
    self.category = category
