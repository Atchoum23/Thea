...
//
//  Model types (CustomAgent, KnowledgeItem, etc.) are in CustomAgentBuilderTypes.swift
...
// CustomAgent model, supporting types, and errors are in CustomAgentBuilderTypes.swift
