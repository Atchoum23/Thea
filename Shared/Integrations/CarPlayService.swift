...
extension CarPlayService: CPInterfaceControllerDelegate {
    public nonisolated func templateWillAppear(_ aTemplate: CPTemplate, animated: Bool) {
        Task { @MainActor in
            self.currentTemplate = aTemplate
        }
    }

    public nonisolated func templateDidAppear(_ aTemplate: CPTemplate, animated: Bool) {}

    public nonisolated func templateWillDisappear(_ aTemplate: CPTemplate, animated: Bool) {}

    public nonisolated func templateDidDisappear(_ aTemplate: CPTemplate, animated: Bool) {}
}
