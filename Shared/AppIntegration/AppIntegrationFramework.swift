...
public actor AppIntegrationFramework {
    ...
    public func pressShortcut(_ shortcut: KeyboardShortcut) async throws {
        #if os(macOS)
        let source = CGEventSource(stateID: .hidSystemState)
...
public struct IntegrationAction: Codable, Sendable, Identifiable {
    ...
    public init(name: String, description: String, shortcut: KeyboardShortcut? = nil) {
        self.name = name
...
public struct KeyboardShortcut: Codable, Sendable {
    ...
    // Common shortcuts
    public static let copy = KeyboardShortcut(keyCode: 8, modifiers: .command) // Cmd+C
    public static let paste = KeyboardShortcut(keyCode: 9, modifiers: .command) // Cmd+V
    public static let selectAll = KeyboardShortcut(keyCode: 0, modifiers: .command) // Cmd+A
    public static let save = KeyboardShortcut(keyCode: 1, modifiers: .command) // Cmd+S
    public static let undo = KeyboardShortcut(keyCode: 6, modifiers: .command) // Cmd+Z
}
...
public enum IntegrationError: Error, LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .accessibilityNotGranted:
            return "Accessibility permission is required. Please grant access in System Settings."
