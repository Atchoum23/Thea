...
extension FocusModeIntelligence {
    ...
    func saveAnalytics() async {
        ...
        do {
            ...
            logger.error("Failed to encode focus mode analytics: \(error.localizedDescription)")
        }
    }
    ...
    func executeWithVerification(
        ...
        for attempt in 1...maxRetries {
            ...
            if success {
                ...
                if verificationMethod == .pollStatus {
                    do {
                        ...
                        break // Task cancelled during verification wait
                    }
            ...
            do {
                ...
                break // Task cancelled during retry wait
            }
        }
    ...
    func notifyUserOfFailedAction(_ actionType: PendingAction.ActionType) async {
        ...
        do {
            ...
            logger.error("Failed to schedule action failure notification: \(error.localizedDescription)")
        }
        ...
        if let prediction = await predictFocusModeActivation(),
           ...
           let modeName = prediction.suggestedMode {
            ...
            do {
                ...
                logger.error("Failed to schedule focus mode suggestion notification: \(error.localizedDescription)")
            }
        }
    }
