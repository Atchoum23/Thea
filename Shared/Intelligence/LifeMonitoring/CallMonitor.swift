...
// MARK: - Module Logger
private let callMonitorLogger = Logger(subsystem: "ai.thea.app", category: "CallMonitor")
    ...
    private func extractKeyPoints(_ text: String) -> [String] {
        ...
        for pattern in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid key point pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
    ...
    private func extractActionItems(_ text: String, call: CallRecord) -> [CallAnalysis.ActionItem] {
        ...
        for (pattern, priority) in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid action item pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
    ...
    private func extractCommitments(_ text: String, call: CallRecord) -> [CallAnalysis.Commitment] {
        ...
        for pattern in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid commitment pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
    ...
    private func extractFollowUps(_ text: String) -> [CallAnalysis.FollowUp] {
        ...
        for (pattern, type) in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid follow-up pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
    ...
    private func extractDeadlines(_ text: String) -> [CallAnalysis.MentionedDeadline] {
        ...
        for pattern in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid deadline detection pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
    ...
    private func extractDecisions(_ text: String) -> [CallAnalysis.Decision] {
        ...
        for pattern in patterns {
            do {
                ...
                callMonitorLogger.error("Invalid decision pattern '\(pattern)': \(error.localizedDescription)")
            }
        }
