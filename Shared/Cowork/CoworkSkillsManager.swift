...
// periphery:ignore - Reserved: canHandle(url:) instance method reserved for future feature activation
        ...
        func createDocument(
            skill: SkillType,
            // periphery:ignore - Reserved: skillsForExtension(_:) instance method reserved for future feature activation
            name: String,
            at directory: URL,
            content: String? = nil
        ) async throws -> URL {
            ...
            // periphery:ignore - Reserved: createDocument(skill:name:at:content:) instance method reserved for future feature activation
        ...
        private func createSpreadsheet(at url: URL, content: String?) async throws -> URL {
            ...
            // periphery:ignore - Reserved: createTextDocument(at:content:) instance method reserved for future feature activation
            return url
        }

        private func createCodeFile(at url: URL, content: String?) async throws -> URL {
            let code = content ?? "// Generated by Thea Cowork\n"
            // periphery:ignore - Reserved: createSpreadsheet(at:content:) instance method reserved for future feature activation
        ...
        private func createDataFile(at url: URL, content: String?) async throws -> URL {
            let data = content ?? "{}"
            // periphery:ignore - Reserved: createCodeFile(at:content:) instance method reserved for future feature activation
...
// periphery:ignore - Reserved: createDataFile(at:content:) instance method reserved for future feature activation
        ...
        func organizeFiles(
            ...
            // periphery:ignore - Reserved: organizeFiles(in:strategy:) instance method reserved for future feature activation
            }
        ...
        // periphery:ignore - Reserved: OrganizationStrategy type reserved for future feature activation
        }
        ...
        // periphery:ignore - Reserved: SkillError type reserved for future feature activation
