...
final class ShortcutsManager {
  ...
  private func handleStartConversation(_ intent: StartConversationIntent) async throws
    -> ShortcutAction
  {
  ...
  private func handleAskQuestion(_ intent: AskQuestionIntent) async throws -> ShortcutAction {
    ...
    guard ProviderRegistry.shared.getProvider(id: SettingsManager.shared.defaultProvider) != nil
    else {
