...
// tvOS-specific features for Apple TV
    ...
    public class TheaTopShelfProvider: TVTopShelfContentProvider {
        override public func loadTopShelfContent() async -> TVTopShelfContent? {
    ...
    public final class SiriRemoteManager: ObservableObject {
        ...
        @objc private func handlePlayPause(_: UITapGestureRecognizer) {
            lastGesture = .playPause
            onPlayPause?()
        }

        @objc private func handleMenu(_: UITapGestureRecognizer) {
            lastGesture = .menu
            onMenu?()
        }
    ...
    public final class FocusEngineManager: ObservableObject {
        ...
        public func requestFocus(to item: UIFocusItem, in _: UIFocusUpdateContext? = nil) {
            ...
            logger.debug("Focus requested for: \(currentFocusedItem ?? "unknown")")
        }
        ...
        public func focusSound(for _: UIFocusItem) -> UIFocusMovementHint.SoundIdentifier {
            .default
        }
    }
    ...
    public final class TVDisplayManager: ObservableObject {
        ...
        public func optimalFontSize(for style: FontStyle) -> CGFloat {
            ...
            let multiplier: CGFloat = switch textSize {
            case .small: 0.85
            case .medium: 1.0
            case .large: 1.2
            case .extraLarge: 1.4
