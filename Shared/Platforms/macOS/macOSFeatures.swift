...
// macOS-specific features: Menu Bar, Global Shortcuts, Touch Bar, AppleScript, Finder integration
    ...
    public final class GlobalHotkeyManager: ObservableObject {
        ...
        public func registerAllHotkeys() {
            ...
            logger.info("Registered \(self.registeredHotkeys.count { $0.isEnabled }) global hotkeys")
        }
    ...
    public enum HotkeyAction: Codable, Equatable {
        ...
        public var rawValue: String {
            switch self {
            case .activateThea: "activate"
            case .quickAsk: "quickAsk"
            case .screenshotAndAsk: "screenshotAsk"
            case .processClipboard: "clipboard"
            case .voiceInput: "voice"
            case .newConversation: "newConversation"
            case .toggleWindow: "toggleWindow"
            case let .custom(id): "custom:\(id)"
            }
        }
    }
    ...
    public enum AppleScriptError: Error, LocalizedError {
        ...
        public var errorDescription: String? {
            ...
            case let .executionFailed(details):
                "AppleScript execution failed: \(details)"
            }
        }
    }
    ...
    public final class TheaServiceProvider: NSObject {
        @objc public func processText(_ pboard: NSPasteboard, userData: String, error _: AutoreleasingUnsafeMutablePointer<NSString?>) {
        ...
        @objc public func askThea(_ pboard: NSPasteboard, userData _: String, error _: AutoreleasingUnsafeMutablePointer<NSString?>) {
            guard let text = pboard.string(forType: .string) else { return }
