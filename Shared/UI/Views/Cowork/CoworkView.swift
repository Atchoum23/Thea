...
struct CoworkView: View {
    ...
    private func iconForTab(_ tab: CoworkTab) -> String {
        switch tab {
        case .progress: return "list.bullet.clipboard"
    ...
    private var instructionInputArea: some View {
        VStack(spacing: 12) {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 8) {
                    QuickActionButton(title: "Organize Downloads", icon: "folder.badge.gearshape") {
                        instructionText = "Organize my Downloads folder by file type"
                    }
                    QuickActionButton(title: "Clean Duplicates", icon: "doc.on.doc.fill") {
                        instructionText = "Find and remove duplicate files"
                    }
                    QuickActionButton(title: "Generate Report", icon: "doc.text.fill") {
                        instructionText = "Generate a summary report of the folder contents"
                    }
                    QuickActionButton(title: "Backup Important", icon: "externaldrive.fill.badge.plus") {
