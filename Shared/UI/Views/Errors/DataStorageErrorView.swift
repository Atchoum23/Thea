...
#Preview {
  DataStorageErrorView(
    error: ModelContainerError.initializationFailed(
      persistentError: NSError(
        domain: "com.thea", code: 1, userInfo: [NSLocalizedDescriptionKey: "Disk full"]),
      fallbackError: NSError(
        domain: "com.thea", code: 2,
