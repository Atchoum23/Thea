    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    PermissionRow(permission: .viewScreen, isRequested: true)
                    PermissionRow(permission: .controlScreen, isRequested: true)
                    PermissionRow(permission: .viewFiles, isRequested: true)
                    PermissionRow(permission: .readFiles, isRequested: true)
                } header: {
...
private struct PermissionRow: View {
    ...
    private var permissionIcon: String {
        switch permission {
        case .viewScreen: return "eye"
        case .controlScreen: return "cursorarrow.click"
        case .viewFiles: return "folder"
        case .readFiles: return "doc"
        case .writeFiles: return "doc.badge.plus"
        case .deleteFiles: return "trash"
        case .executeCommands: return "terminal"
        case .systemControl: return "power"
